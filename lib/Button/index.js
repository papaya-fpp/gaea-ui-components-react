...
var Button = function (_a) {
    ...
    return (react_1.default.createElement("button", __assign({ disabled: disabled, type: "button", className: ["".concat(prefixCls), "".concat(prefixCls, "--").concat(size), mode, disabledState, dangerState, loadingState, className].join(' '), style: __assign({ backgroundColor: backgroundColor }, style) }, props),
