...
var SaveButtonBar = function (props) {
    var handleCancel = props.handleCancel, handleSave = props.handleSave, _a = props.isShow, isShow = _a === void 0 ? true : _a, _b = props.loading, loading = _b === void 0 ? false : _b, _c = props.cancelText, cancelText = _c === void 0 ? '取消' : _c, _d = props.saveText, saveText = _d === void 0 ? '确定' : _d, _e = props.tipText, tipText = _e === void 0 ? '' : _e;
    var prefixCls = (0, responsiveObserve_1.getPrefixCls)('save-button-bar');
    return (react_1.default.createElement(react_1.default.Fragment, null, isShow && (react_1.default.createElement("div", { className: "".concat(prefixCls, " clearfix") },
        tipText && (react_1.default.createElement("div", { className: "".concat(prefixCls, "-tip") }, tipText)),
