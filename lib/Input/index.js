...
var Input = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "".concat(prefixClsInput, "-body ").concat(className) },
        ...
        type === 'textarea' ? (react_1.default.createElement("div", { className: "".concat(prefixClsTextarea) + " ".concat(size) + (error ? ' error' : '') + (readonly ? ' readonly' : '') },
            react_1.default.createElement("textarea", { className: "".concat(prefixClsTextarea, "-affix-wrapper"), ref: ref, placeholder: placeholder, id: id, name: name, readOnly: readonly, value: val, maxLength: maxLength, onFocus: function () {
                    if (onFocus) {
                        onFocus();
                    }
                }, onBlur: function (e) {
                ...
                } }))) : (react_1.default.createElement("div", { className: "".concat(prefixClsInput) + " ".concat(size) + (error ? ' error' : '') + (readonly ? ' readonly' : '') },
            react_1.default.createElement("div", { className: "".concat(prefixClsInput, "-wrapper") + (groupAddon ? " ".concat(prefixClsInput, "-group") : '') },
                react_1.default.createElement("div", { className: "".concat(prefixClsInput, "-affix-wrapper") },
                    ...
                    react_1.default.createElement("input", { ref: ref, placeholder: placeholder, type: typeTemp === 'number' ? 'text' : typeTemp, id: id, name: name, readOnly: readonly, value: val, maxLength: maxLength, onFocus: function () {
                            if (onFocus) {
                                onFocus();
                            }
                        }, onBlur: function (e) {
                    ...
                    react_1.default.createElement("div", { className: "".concat(prefixClsInput, "-all-icon") },
                        val && allowClear && !readonly && (react_1.default.createElement(Icon_1.default, { className: ["".concat(prefixClsInput, "-clear"), passwordIcon ? "".concat(prefixClsInput, "-clear-space") : ''].join(' '), onClick: handleClear, name: "guanbi1" })),
