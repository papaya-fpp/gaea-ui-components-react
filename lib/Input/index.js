...
var Input = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "".concat(prefixClsInput, "-body ").concat(className) },
        ...
        react_1.default.createElement("div", { className: "end-section clearfix" },
            react_1.default.createElement("div", { className: 'error-text' + (errorText != '' ? '' : ' is-hide') }, errorText),
            type === 'textarea' && suffix && (react_1.default.createElement("div", { className: "".concat(prefixClsTextarea, "-all-icon") },
                react_1.default.createElement("div", { className: "".concat(prefixClsTextarea, "-suffix") }, suffix && (suffix)))))));
};
exports.Input = Input;
