...
var TableComp = function (props) {
    var columns = props.columns, dataSource = props.dataSource, rowKey = props.rowKey, _a = props.bordered, bordered = _a === void 0 ? false : _a, width = props.width, pagination = props.pagination, onRow = props.onRow;
    ...
    var handleOnClickRow = function (item) {
        onRow === null || onRow === void 0 ? void 0 : onRow.onClick(item);
    };
    var handleOnMouseEnterRow = function (item) {
        onRow === null || onRow === void 0 ? void 0 : onRow.onMouseEnter(item);
    };
    var handleOnMouseLeaveRow = function (item) {
        onRow === null || onRow === void 0 ? void 0 : onRow.onMouseLeave(item);
    };
    // 创建 thead
    ...
    var createRow = function () {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null, tableList.map(function (item) {
            ...
            if (item.description) {
                return (react_1.default.createElement("tr", { onClick: function () { (onRow === null || onRow === void 0 ? void 0 : onRow.onClick) && handleOnClickRow(item); }, onMouseEnter: function () { (onRow === null || onRow === void 0 ? void 0 : onRow.onMouseEnter) && handleOnMouseEnterRow(item); }, onMouseLeave: function () { (onRow === null || onRow === void 0 ? void 0 : onRow.onMouseLeave) && handleOnMouseLeaveRow(item); }, key: item.key, style: style, className: "table-row-level-".concat(item.level) },
                    react_1.default.createElement("td", { colSpan: columns.length }, item.description)));
            }
            return (react_1.default.createElement("tr", { onClick: function () { (onRow === null || onRow === void 0 ? void 0 : onRow.onClick) && handleOnClickRow(item); }, onMouseEnter: function () { (onRow === null || onRow === void 0 ? void 0 : onRow.onMouseEnter) && handleOnMouseEnterRow(item); }, onMouseLeave: function () { (onRow === null || onRow === void 0 ? void 0 : onRow.onMouseLeave) && handleOnMouseLeaveRow(item); }, key: getRowKey(item), style: style, className: "table-row-level-".concat(item.level) }, createCol(item)));
        })));
    };
    // 创建 列
