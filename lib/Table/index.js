...
var TableComp = function (props) {
    var columns = props.columns, dataSource = props.dataSource, rowKey = props.rowKey, _a = props.bordered, bordered = _a === void 0 ? false : _a, width = props.width, pagination = props.pagination;
    ...
    var createTHead = function () {
        return (react_1.default.createElement("thead", null,
            react_1.default.createElement("tr", null, columns.map(function (item) {
                return react_1.default.createElement("th", { key: item.key || item.dataIndex }, item.title);
            }))));
    };
    // 创建 行
    var createRow = function () {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null, tableList.map(function (item) {
            ...
            if (item.description) {
                return (react_1.default.createElement("tr", { key: item.key, style: style, className: "table-row-level-".concat(item.level) },
                    react_1.default.createElement("td", { colSpan: columns.length }, item.description)));
            }
            return (react_1.default.createElement("tr", { key: getRowKey(item), style: style, className: "table-row-level-".concat(item.level) }, createCol(item)));
        })));
    };
    // 创建 列
    var createCol = react_1.default.useCallback(function (obj) {
        return (react_1.default.createElement(react_1.default.Fragment, null, columns.map(function (item, index) {
            ...
            return (react_1.default.createElement("td", { key: key, "data-key": key, "data-rowkey": _rowKey, className: classes },
    ...
    return (react_1.default.createElement("div", { className: prefixCls },
        react_1.default.createElement("table", { className: "".concat(prefixCls, "-wrapper"), ref: tableRef },
            (0, ulils_1.createColgroup)(columns),
            createTHead(),
