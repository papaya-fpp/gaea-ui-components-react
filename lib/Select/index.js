...
var Select = function (_a) {
    var label = _a.label, _b = _a.placeholder, placeholder = _b === void 0 ? '' : _b, value = _a.value, onChange = _a.onChange, _c = _a.allowClear, allowClear = _c === void 0 ? false : _c, showSearch = _a.showSearch, className = _a.className, _d = _a.filterOption, filterOption = _d === void 0 ? defaultFilter : _d, onBlur = _a.onBlur, onFocus = _a.onFocus, children = _a.children, _e = _a.readonly, readonly = _e === void 0 ? false : _e;
    ...
    return (react_1.default.createElement("div", { className: "".concat(prefixCls, "-container") },
        ...
        react_1.default.createElement("div", { className: "".concat(prefixCls, "-wrapper ").concat(!filterOption ? "".concat(prefixCls, "-cursorPointer") : '', " ").concat(className ? className : '', " ").concat(readonly ? ' readonly' : '') },
            ...
            react_1.default.createElement("input", { readOnly: readonly, ref: inputRef, className: "".concat(prefixCls, "-input ").concat(!showSearch ? 'nosearch' : ''), value: inputval, onChange: inputChange, onFocus: inputFocus, onBlur: inputBlur }),
            childText && allowClear && !readonly && (react_1.default.createElement("div", { className: "".concat(prefixCls, "-clear"), onClick: handleClear },
                react_1.default.createElement(Icon_1.default, { name: "guanbi1" }))),
            react_1.default.createElement("div", { className: "".concat(prefixCls, "-jiantou"), onClick: clickFocus }, (showList || readonly) ? (react_1.default.createElement(Icon_1.default, { name: "Retract" })) : (react_1.default.createElement(Icon_1.default, { name: "Drop-down" })))),
        getListNode()));
};
