...
var Card = function (_a) {
    var title = _a.title, extra = _a.extra, children = _a.children, footer = _a.footer, expandable = _a.expandable, style = _a.style, className = _a.className;
    var prefixCls = (0, responsiveObserve_1.getPrefixCls)("card");
    var cardClassName = (0, classnames_1.default)(prefixCls, className);
    var _b = (0, react_1.useState)(true), fold = _b[0], setFold = _b[1];
    var handleFold = function () {
        setFold(!fold);
    };
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { style: style, className: cardClassName },
